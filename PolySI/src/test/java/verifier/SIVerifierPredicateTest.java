...
/**
 * 纯单元测试：验证 SIVerifier 中新增的 predicate 边推导辅助函数。
...
public class SIVerifierPredicateTest {
    ...
    void matchesPredicate_writeValueSatisfiesPredicate() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "matchesPredicate",
    ...
    void isFlipWitness_prevNotMatch_currMatches() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "isFlipWitness",
    ...
    void resolveLatestFlipWitnessBeforeIndex_returnsClosestFlip() throws Exception {
        ...
        Method m = findMethod(SIVerifier.class, "resolveLatestFlipWitnessBeforeIndex",
